...
async def start(u: Update, c: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "Отправь видео/фото <b>или ссылку на видео</b>.<br><br>"
        "🎬 <b>Видео</b> — большая прозрачная метка по центру «летает».<br>"
        "🖼 <b>Фото</b> — метка диагонально на весь кадр.<br>"
        "📦 <b>Большие файлы</b>: пришли <b>ссылку</b> — бот сам скачаeт.<br><br>"
        "Поддерживаю Google Drive и Dropbox — превращу «поделиться» в прямую ссылку.<br>"
